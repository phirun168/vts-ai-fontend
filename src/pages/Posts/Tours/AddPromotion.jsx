...
const Promotion = ({ open, setOpen }) => {
    ...
    return (
        ...
        >
            ...
            >
                <Form form={form} layout='vertical' name='promotion'>
                    <Row gutter={[8, 2]}>
                        <Col xs={24}>
                            <Form.Item label='Promotion Type' name='promotion_type' style={{ marginBottom: 0 }}>
                        ...
                        {selectedType === 'text' && (
                            <Col xs={24}>
                                <Form.Item
                                    ...
                                    rules={[{ required: true, message: 'field require!' }]}
                                >
                                    <Input.TextArea placeholder='Enter text description' rows={3} />
                                </Form.Item>
                            </Col>
                        )}

                        <Col xs={24}>
                            <Form.Item style={{ marginBottom: '0px' }} label='Schedule' name='date_option' rules={[{ required: true, message: 'Field Require' }]}
                            >
                                <Radio.Group onChange={handleDateOptionChange} value={dateOption}>
