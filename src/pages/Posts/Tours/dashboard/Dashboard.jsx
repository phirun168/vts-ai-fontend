...
const Dashboard = ({ data = [] }) => {
  // Compute counts based on the tour data.
    ...
    <Row gutter={[16, 16]} className='mb-2 mt-1'>
      <Col xs={24} sm={12} md={6}>
        ...
        >
          ...
          <div style={{ fontSize: '12px' }}>All Tours</div>
        </Card>
      </Col>
      <Col xs={24} sm={12} md={6}>
        <Card
        ...
        >
          ...
          <div style={{ fontSize: '12px' }}>Active Tours</div>
        </Card>
      </Col>
      <Col xs={24} sm={12} md={6}>
        <Card
        ...
        >
          ...
          <div style={{ fontSize: '12px' }}>Inactive Tours</div>
        </Card>
      </Col>
      <Col xs={24} sm={12} md={6}>
        <Card
        ...
        >
          ...
          <div style={{ fontSize: '12px' }}>Expired Tours</div>
        </Card>
      </Col>
    </Row>
  )
