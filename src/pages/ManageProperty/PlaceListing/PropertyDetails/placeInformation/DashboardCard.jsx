...
import { EyeOutlined, SaveOutlined, ShareAltOutlined } from '@ant-design/icons'
...
const stats = [
  {
    title: 'View',
    count: 1450,
    icon: <EyeOutlined style={{ fontSize: 20, color: '#fff' }} />,
    iconBg: '#4F83FF',
    cardBg: '#EEF4FF',
  },
  {
      ...
      {stats.map((s) => (
        <Col key={s.title} xs={24} sm={12} md={6}>
          ...
          >
            ...
            <div>
              <Text style={{ color: '#666', fontSize: 14 }}>{s.title}</Text>
