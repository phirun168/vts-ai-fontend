...
const ProfileThumbnailEditor = (props) => {
  const { avatar, setAvatar, thumbnail, getFileByName, open, setOpen } = props
  console.log(thumbnail?.[0], 'thumbnail')
  ...
  useEffect(() => {
    if (open && !filePreview) {
      setFilePreview(getFileByName(thumbnail?.[0]))
    }
  }, [open, thumbnail, filePreview])
